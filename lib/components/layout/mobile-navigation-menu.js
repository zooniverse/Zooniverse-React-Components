...
function MobileNavigationMenu(props) {
  ...
  if (props.isMobile) {
    return /*#__PURE__*/_react["default"].createElement(_Menu["default"], {
      ...
      icon: /*#__PURE__*/_react["default"].createElement(_Menu2["default"], {
        size: "xsmall"
      }),
      dropAlign: {
        right: 'right',
...
MobileNavigationMenu.defaultProps = {
  ...
  isAdmin: false,
  isMobile: false,
  mobileNavList: [/*#__PURE__*/_react["default"].createElement(_Anchor["default"], {
    className: "zoo-header__link--small",
...
var _default = (0, _withMobileView["default"])(MobileNavigationMenu);
