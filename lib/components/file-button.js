...
var FileButton = function (_React$Component) {
  ...
  _createClass(FileButton, [{
    ...
    value: function render() {
      ...
      var style = Object.assign({}, this.props.rootStyle, this.props.style, {
        'data-accept': this.props.accept,
        'data-disabled': this.props.disabled || null,
        'data-multiple': this.props.multiple || null
      });

      return _react2.default.createElement(this.props.tag, { className: ('file-button ' + this.props.className).trim(), style: style }, _react2.default.createElement(
        'span',
