...
var FileButton = function (_React$Component) {
  ...
  _createClass(FileButton, [{
    ...
    value: function render() {
      ...
      var props = Object.assign({}, this.props.rootStyle, this.props.style, {
        dataAccept: this.props.accept,
        dataDisabled: this.props.disabled || null,
        dataMultiple: this.props.multiple || null
      });

      return _react2.default.createElement(this.props.tag, { className: ('file-button ' + this.props.className).trim(), props: props }, _react2.default.createElement(
        'span',
