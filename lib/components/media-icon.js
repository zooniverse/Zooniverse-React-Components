...
var MediaIcon = function (_React$Component) {
  ...
  _createClass(MediaIcon, [{
    ...
    key: 'handleMarkdownFocus',
    value: function handleMarkdownFocus(e) {
    ...
    value: function render() {
      ...
      var markdown = '![' + this.props.resource.metadata.filename + '(' + this.props.resource.src + ')';
      return _react2.default.createElement(
        ...
        _react2.default.createElement('textarea', { className: 'media-icon-markdown', value: markdown, readOnly: true, style: { position: 'relative' }, onFocus: this.handleMarkdownFocus })
      );
    }
  }]);
